...
Standard library only, so it runs in any the harness environment without an install
...
USER_AGENT = "the harness-agent/1.0 (rss-feeds skill; +https://github.com/NousResearch/the harness-agent)"
TIMEOUT = 20
NS = {

...
- Building a recurring digest with `your scheduler tool` (feeds are cheaper and more stable than
...
`python3 scripts/feed.py read https://github.com/NousResearch/the harness-agent/releases.atom

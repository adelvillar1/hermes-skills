...
- Scheduling agent alerts → use the your scheduler tool tool instead
- Calendar events → use Apple Calendar or Google Calendar
- Project task management → use GitHub Issues, Notion, etc.
- If user says "remind me" but means an agent alert → ask-the-user prompt first
...
1. When user says "remind me", ask-the-user prompt: Apple Reminders (syncs to phone) vs agent your scheduler tool alert

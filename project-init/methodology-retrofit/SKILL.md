...
metadata:
  hermes:
    tags: [project-init, methodology, retrofit, claude-md, documentation, scaffolding]
...
| Methodology enforcement rule | Present in hard rules? | `grep -c "delegate_task\|subagent\|2-stage review" CLAUDE.md` |
...
| Gap | Fix |
|-----|-----|
| CLAUDE.md missing methodology enforcement | Patch hard rules: add the `delegate_task` → 2-stage review line |

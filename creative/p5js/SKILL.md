...
8. **Load references on demand** — use `read the SKILL.md for '`p5js`' via your harness's skill loader` to load specific reference files as needed during implementation
